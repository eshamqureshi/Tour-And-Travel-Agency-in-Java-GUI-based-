...
public class CheckHotels extends JFrame implements Runnable {
    ...
    public void run() {
        try {
            ...
            l2.setVisible(true);
            caption.setText("Marriott Hotel");
            l2.add(caption);
            Thread.sleep(2800);
            l2.setVisible(false);
            l3.setVisible(true);
            caption.setText("Sarena Hotel");
            l3.add(caption);
            l3.setVisible(true);
            Thread.sleep(2800);
            l3.setVisible(false);
            l4.setVisible(true);
            caption.setText("centaurus");
            l4.add(caption);
            Thread.sleep(2800);
            l4.setVisible(false);
            l5.setVisible(true);
            ...
            l5.setVisible(false);
            l6.setVisible(true);
            caption.setText("Double Tree Hotel");
            l6.add(caption);
            Thread.sleep(2800);
            l6.setVisible(false);
            l7.setVisible(true);
            caption.setText("Exclusion Hotel");
            l7.add(caption);
            Thread.sleep(2800);
            l7.setVisible(false);
            l8.setVisible(true);
    ...
    public CheckHotels() {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/hotel.jpeg"));
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/hotel1.jpeg"));
        ...
        ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("icons/hotel3.jpeg"));
        ...
        ImageIcon i13 = new ImageIcon(ClassLoader.getSystemResource("icons/hotel6.jpeg"));
        ...
        ImageIcon i16 = new ImageIcon(ClassLoader.getSystemResource("icons/hotel7.jpg"));
        ...
        ImageIcon i19 = new ImageIcon(ClassLoader.getSystemResource("icons/hotel8.jpg"));
        ...
        ImageIcon i22 = new ImageIcon(ClassLoader.getSystemResource("icons/hotel2.jpeg"));
        ...
        ImageIcon i25 = new ImageIcon(ClassLoader.getSystemResource("icons/hotel1.jpg"));
        ...
        ImageIcon i28 = new ImageIcon(ClassLoader.getSystemResource("icons/hotel1.jpg"));
